    ...
    while True:
        ...
        try:
            ...
            if Argumente == 8:
                ...
                send_to_midea()
                _LOGGER.info("Übertragung erfolgreich")
            elif data[0] == "status":
            ...
            print("Fehler bei send_to_midea, Übertragung abgebrochen")
            _LOGGER.info("Fehler bei send_to_midea, , Übertragung abgebrochen")
